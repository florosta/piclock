...
export default function ClockView({ onOpenPodcasts, currentEpisode, playing, onToggle }: Props) {
    ...
    <div style={styles.root} onClick={onOpenPodcasts}>
      ...
      {currentEpisode && (
        <div style={styles.miniPlayer} onClick={e => e.stopPropagation()}>
          ...
          <button style={styles.miniBtn} onClick={onToggle}>
            {playing ? '⏸' : '▶'}
          </button>
        </div>
      )}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  date: {
    ...
    marginTop: '3vw', letterSpacing: '0.2em',
    textTransform: 'uppercase',
  },
  hint: {
    fontSize: '2vw', opacity: 0.2,
    marginTop: '4vw', letterSpacing: '0.15em',
  },
  miniPlayer: {
    ...
    borderRadius: '2vw', padding: '1.5vw 2.5vw',
    maxWidth: '80vw',
  },
  miniTitle: {
  ...
  miniBtn: {
    ...
    fontSize: '3vw', cursor: 'pointer', lineHeight: 1,
    padding: '0.5vw',
  },
}
